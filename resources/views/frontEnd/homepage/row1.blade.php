...
<section class="content-row-no-bg home-welcome">
    <div class="container">
        ...
        <div class="text-center mt-3">
            <a href="{{ $form_url }}" class="">
               <div class="strong-link">
                <strong>Stop wasting time and money on technology. <span>Explore Our Company</span></strong>
               </div>
...
@if(count($TextBanners)>0)
    ...
    ?>
    <section id="services" class="services service-change">
        <div class="container">
            <div class="row">

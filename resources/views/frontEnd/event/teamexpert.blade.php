<section>
    <div class="expert-title counter-counts mt-5" is="expert-title">
        <div class="main-expert-title container ">
            <div class="team-invest">
                <h2 class="pace-invest-chances">Connect <span>with Our</span> </h2>
                <h3>Team of Experts</h3>
                <p>Contact our team of excellence- driven <br> experts today to bring your project to life.</p>

                <div class="expert-girls-invest">
                    <div class="classical-invest">
                        <h3 class="visit-invest">You want to invest <br> In Us</h3>
                        <p class="mt-3"><a href="https://vitib.ci/about">Visit Our Website</a><i class="fa-solid fa-arrow-right mx-2"></i></p>
                    </div>
                    <div class="right-way-sides">
                        <img src="./assets/image/boy.png" alt="boy">
                    </div>
                </div>
            </div>
            <div class="form-action action-dl">

                <form method="post" action="">
                    <div class="row">
                        <div class="col">
                            <input type="text" class="form-control" placeholder="First name" aria-label="First name">
                            <!-- <span class="text-danger">safdsafddsf</span> -->
                        </div>
                        <div class="col">
                        ...
                        <div class="col">
                            <div class="iti iti--allow-dropdown iti--separate-dial-code">
                                <div class="iti__flag-container">
                                    <div class="iti__selected-flag" role="combobox" aria-controls="iti-0__country-listbox" aria-owns="iti-0__country-listbox" aria-expanded="false" tabindex="0" title="Côte d’Ivoire: +225" aria-activedescendant="iti-0__item-ci-preferred">
                                        <div class="iti__flag iti__ci"></div>
                                        <div class="iti__selected-dial-code">+225</div>
                                        <div class="iti__arrow"></div>
                                    </div>
                                    <ul class="iti__country-list iti__hide" id="iti-0__country-listbox" role="listbox" aria-label="List of countries">
                                        <li class="iti__country iti__preferred iti__active" tabindex="-1" id="iti-0__item-ci-preferred" role="option" data-dial-code="225" data-country-code="ci" aria-selected="true">
                                            <div class="iti__flag-box">
                                                <div class="iti__flag iti__ci"></div>
                                            </div><span class="iti__country-name">Côte d’Ivoire</span><span class="iti__dial-code">+225</span>
                                        </li>
                                        <li class="iti__country iti__preferred" tabindex="-1" id="iti-0__item-ng-preferred" role="option" data-dial-code="234" data-country-code="ng" aria-selected="false">
                                            <div class="iti__flag-box">
                                                <div class="iti__flag iti__ng"></div>
                                            </div><span class="iti__country-name">Nigeria</span><span class="iti__dial-code">+234</span>
                                        </li>
                                        <li class="iti__country iti__preferred" tabindex="-1" id="iti-0__item-gh-preferred" role="option" data-dial-code="233" data-country-code="gh" aria-selected="false">
                                            <div class="iti__flag-box">
                                                <div class="iti__flag iti__gh"></div>
                                            </div><span class="iti__country-name">Ghana (Gaana)</span><span class="iti__dial-code">+233</span>
                                        </li>
                                        <li class="iti__country iti__preferred" tabindex="-1" id="iti-0__item-bj-preferred" role="option" data-dial-code="229" data-country-code="bj" aria-selected="false">
                                            <div class="iti__flag-box">
                                                <div class="iti__flag iti__bj"></div>
                                            </div><span class="iti__country-name">Benin (Bénin)</span><span class="iti__dial-code">+229</span>
                                        </li>
                                        <li class="iti__country iti__preferred" tabindex="-1" id="iti-0__item-bf-preferred" role="option" data-dial-code="226" data-country-code="bf" aria-selected="false">
                                            <div class="iti__flag-box">
                                ...
                                </div><input id="phone" type="tel" class="form-control" autocomplete="off" data-intl-tel-input-id="0" placeholder="01 23 45 6789" style="padding-left: 97px;">
                            </div>
                        </div>
                        <div class="col">
                    ...
                    <button class="btn-submit submit-btn text-white">
                        Submit
                    </button>
                </form>
            </div>

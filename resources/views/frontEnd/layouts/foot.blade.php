...
<!-- Vendor JS Files -->
<script src="{{ URL::asset('public/assets/frontend/js/jquery.min.js') }}?v={{ Helper::system_version() }}"></script>
{{-- <script
    src="{{ URL::asset('public/assets/frontend/vendor/bootstrap/js/bootstrap.bundle.min.js') }}?v={{ Helper::system_version() }}"></script>
<script
    src="{{ URL::asset('public/assets/frontend/vendor/glightbox/js/glightbox.min.js') }}?v={{ Helper::system_version() }}"></script>
<script
    src="{{ URL::asset('public/assets/frontend/vendor/swiper/swiper-bundle.min.js') }}?v={{ Helper::system_version() }}"></script>
<script
    src="{{ URL::asset('public/assets/frontend/vendor/owl-carousel/owl.carousel.js') }}?v={{ Helper::system_version() }}"></script> --}}

<!-- Template Main JS File -->
<script src="{{ URL::asset('public/assets/frontend/js/main.js') }}?v={{ Helper::system_version() }}"></script>

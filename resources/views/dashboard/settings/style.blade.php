                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="col-sm-12 box p-a-xs text-center">
                                    <a target="_blank"
                                       href="{{ asset('public/uploads/settings/'.$Setting->{'style_logo_'.@$ActiveLanguage->code}) }}"><img
                                            src="{{ asset('public/uploads/settings/'.$Setting->{'style_logo_'.@$ActiveLanguage->code}) }}"
                    ...
                    @else
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="col-sm-12 box p-a-xs text-center">
                                    <img
                                        src="{{ asset('public/uploads/settings/nologo.png') }}"
                                        class="img-responsive" id="style_logo_{{ @$ActiveLanguage->code }}_prv"
                                        style="width: auto;max-width: 260px;max-height: 60px">
                                    <br>
                ...
                @if($Setting->style_fav!="")
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="col-sm-12 box p-a-xs text-center">
                                <a target="_blank"
                                   href="{{ asset('public/uploads/settings/'.$Setting->style_fav) }}"><img
                                        src="{{ asset('public/uploads/settings/'.$Setting->style_fav) }}"
                ...
                @else
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="col-sm-12 box p-a-xs text-center">
                                <a target="_blank"
                                   href="{{ asset('public/uploads/settings/nofav.png') }}"><img
                                        src="{{ asset('public/uploads/settings/nofav.png') }}"
                                        class="img-responsive" id="style_fav_prv"
                                        style="max-width: 60px;height: 60px">
                                    <br>
                ...
                @if($Setting->style_apple!="")
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="col-sm-12 box p-a-xs text-center">
                                <a target="_blank"
                                   href="{{ asset('public/uploads/settings/'.$Setting->style_apple) }}"><img
                                        src="{{ asset('public/uploads/settings/'.$Setting->style_apple) }}"
                        ...
                        <div>
                            <div>
                                <div id="footer_bg" class="col-sm-8 box p-a-xs">
                                    <a target="_blank"
                                       href="{{ asset('public/uploads/settings/'.$Setting->style_footer_bg) }}"><img
                                            src="{{ asset('public/uploads/settings/'.$Setting->style_footer_bg) }}"
